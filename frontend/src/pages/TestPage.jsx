...
import { Menu, RefreshCw, Search, Settings, Grid, Lightbulb, Moon, Sun } from 'lucide-react';
    ...
    <div className={`flex flex-col h-screen ${themeClasses.mainBg} ${themeClasses.textColor} font-sans transition-colors duration-200`}>
      ...
      <div className={`flex items-center ${themeClasses.headerBorder} border-b h-16 px-4`}>
        ...
        <div className="flex items-center ml-auto">
          ...
          <button className={`p-2 mx-1 rounded-full ${themeClasses.hoverBg}`}>
            <RefreshCw size={20} className={themeClasses.iconColor} />
          </button>
          <button className={`p-2 mx-1 rounded-full ${themeClasses.hoverBg}`}>
            <Settings size={20} className={themeClasses.iconColor} />
          </button>
          <button className={`p-2 mx-1 rounded-full ${themeClasses.hoverBg}`}>
            <Grid size={20} className={themeClasses.iconColor} />
          </button>
      ...
      <div className="flex flex-1">
        ...
        <div className={`w-64 ${themeClasses.sidebarBorder}`}>
          <div className="py-1">
            <div className={`flex items-center px-6 py-3 text-sm font-medium ${themeClasses.selectBg} ${themeClasses.selectText} rounded-r-full`}>
              <Lightbulb size={18} className="mr-8" />
              <span>Notes</span>
            </div>
            <div className={`flex items-center px-6 py-3 text-sm font-medium ${themeClasses.textColor} ${themeClasses.hoverBg} rounded-r-full`}>
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="mr-8">
        ...
        <div className="flex-1 p-4 flex flex-col items-center">
          ...
          <div className={`w-full max-w-md ${themeClasses.cardBg} rounded-lg shadow ${themeClasses.shadowColor} mb-8 px-4 py-3 flex items-center`}>
            ...
            <div className="ml-auto flex">
              <button className={`p-2 ${themeClasses.iconColor}`}>
